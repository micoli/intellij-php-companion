...
object PhpRunner {
    fun executePhpViaStdin(phpBinaryPath: String, phpCode: String, stdin: String): String {
        val process = ProcessBuilder(phpBinaryPath, "-r", phpCode).redirectErrorStream(true).start()
