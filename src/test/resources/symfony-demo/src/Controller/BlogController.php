...
use App\Infrastructure\Bus\DomainEventDispatcher as DomainEventDispatcherInterface;
use App\Infrastructure\Bus\DomainQueryBusInterface;
use App\Repository\TagRepository;
use App\UseCase\ListArticles\Query;
...
final class BlogController extends AbstractController
{
    public function __construct(
        private DomainQueryBusInterface $queryBus,
    ...
    public function index(Request $request, int $page, string $_format, TagRepository $tags): Response
    {
        ...
        $latestPosts = $this->queryBus->query(new Query($page,$tag))->findLatest;
    ...
    public function postShow(Post $post): Response
    {
        ...
        $id = $post->getId();
        assert(is_int($id));
        $this->eventDispatcher->dispatch(new ArticleViewed\Event($id));
        $this->dispatchIsViewed($id);
    ...
    public function dispatchIsViewed(int $id): void
    {
        $this->eventDispatcher->dispatch(new ArticleViewed\Event($id));
    }
}
